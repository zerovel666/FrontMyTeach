    ...
    <div class="payment-page">
        ...
        <div class="payment-container">
            <div class="payment-header">
                <h1>Покупка курса</h1>
                <p class="course-name">К оплате</p>
...
const getPaidInfo = async () => {
    try {
        const response = await axios.get(`${API_URL}/student/course/pay/${route.params.uuid}`);
...
const handlePayment = async () => {
    try {
        ...
        const response = await axios.post(
            `${API_URL}/student/course/paid/${route.params.uuid}`,
            payload
        );
